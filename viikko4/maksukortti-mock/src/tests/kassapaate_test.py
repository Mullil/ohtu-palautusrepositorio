...
class TestKassapaate(unittest.TestCase):
    ...
    def test_maksukortin_lataa_kutsuu_kortin_lataa_jos_summa_positiivinen(self):
        maksukortti_mock = Mock()
        self.kassa.lataa(maksukortti_mock, 10)
        maksukortti_mock.lataa.assert_called_with(10)

    def test_maksukortin_lataa_ei_kutsu_kortin_lataa_jos_summa_negatiivinen(self):
        maksukortti_mock = Mock()
